...
const activities = [
  {
    id: 1,
    type: 'vulnerability',
    title: 'Nova vulnerabilidade CISA Critical detectada',
    description: 'QID 376900 em fw-perimeter-01.corp.local (Layer 1)',
    time: '5 min atrás',
    icon: AlertTriangle,
  ...
  },
  {
    ...
    description: 'QID 731523 em teamcity.dev.corp.local (P2)',
    time: '32 min atrás',
    icon: CheckCircle,
  ...
  },
  {
    id: 5,
    type: 'assignment',
    title: 'Vulnerabilidade P1 atribuída',
    description: 'QID 376562 atribuída a Team-Firewall (Layer 1)',
    time: '3 horas atrás',
    icon: Clock,
